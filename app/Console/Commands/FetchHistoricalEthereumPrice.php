...
class FetchHistoricalEthereumPrice extends Command
{
    ...
    protected $description = 'Fetch and store Ethereum historical price data for a specified date range';
    ...
    public function handle()
    {
        ...
        if ($response->successful()) {
            ...
            if (isset($data['prices'])) {
                ...
                $this->info('Ethereum historical price data has been updated.');
            } else {
